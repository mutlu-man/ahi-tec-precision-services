# AHI-TEC: Inhalte erweitern und Veröffentlichung erklären

## Inhaltliche Erweiterung
- Den Einstiegsbereich stärker auf Präzision, Termintreue und die Entlastung interner Fertigungslinien ausrichten.
...
## Darstellung
- Die vorhandenen Markenfarben Dunkelblau und Rot sowie den industriellen, seriösen Stil fortführen.
- Neue Inhalte gut lesbar und nicht als lange Textwand aufbauen.
- Desktop- und Mobilansicht prüfen.

## Online stellen
- Nach der Umsetzung den einfachsten Veröffentlichungsweg über Lovable erläutern.
- Zusätzlich knapp erklären, wie die Seite auf einem eigenen Server betrieben werden kann und welche Voraussetzungen dafür nötig sind.
